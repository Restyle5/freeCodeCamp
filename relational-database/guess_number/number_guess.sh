...
if [[ -z $USERNAME_RESULT ]]
  then
    ...
    BEST_GAME=$($PSQL "SELECT MIN(total_guessed) FROM games LEFT JOIN users USING(user_id) WHERE username='$USERNAME'")
...
INSERT_GAME_RESULT=$($PSQL "INSERT INTO games(user_id, total_guessed) VALUES ($USER_ID_RESULT, $GUESS_COUNT)")
